...
namespace SocialShareBundle\Twig\Extensions;

class SocialShareBar extends \Twig_Extension{
    ...
    public function getSocialButtons($parameters = array())
    {
      ...
      return $this->container->get('app.socialbar.helper')->socialButtons($render_parameters);
    }
    ...
    public function getFacebookLikeButton($parameters = array())
    {
       ...
       return $this->container->get('app.socialbar.helper')->facebookButton($parameters);
    }
    ...
    public function getTwitterButton($parameters = array())
    {
       ...
       return $this->container->get('app.socialbar.helper')->twitterButton($parameters);
    }
    ...
    public function getGooglePlusButton($parameters = array())
    {
       ...
       return $this->container->get('app.socialbar.helper')->googlePlusButton($parameters);
    }
}